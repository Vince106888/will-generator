...
export default function AiDraftingWorkspace() {
  ...
  const candidateCount = useMemo(() => {
    ...
    if (!c) return 0;
    if (!("extracted" in c)) return 0;
    return (
      c.extracted.assets.length +
      c.extracted.beneficiaries.length +
      c.extracted.executors.length +
      c.extracted.guardians.length +
      c.extracted.specialWishes.length
    );
        ...
        <Container size="wide" className="space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <div className="space-y-4">
              ...
              <HelperCallout
                title="What AI does"
                body="AI helps organize your information. The final draft is generated by the platform after you review the extracted details. Please review carefully before relying on it."
              />
